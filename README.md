...
The application does what a real laboratory information management system would do: checks results against legal drinking water limits, compares outputs between analytical methods, flags QC issues automatically, and generates a dated compliance report. Built entirely in Python, deployed publicly, and every architectural decision is documented.

Target employers include Eurofins, Bureau Veritas, Veolia, Agences de l'eau, and SGS.
...
| 3 | data_loader.py — ingest, validate, BDL handling, merge limits | ⬜ Not started |
...
| 6 | qc_engine.py — flag generation and propagation | ⬜ Not started |
| 7 | method_comparator.py — percentage difference, Bland-Altman, Lin's CCC | ⬜ Not started |
| 8 | Dash app skeleton and Tab 1 (compliance matrix) | ⬜ Not started |
| 9 | Tabs 2 through 5 | ⬜ Not started |
| 10 | report_generator.py — PDF output from button click | ⬜ Not started |
| 11 | README final polish, methodology section, screenshot | ⬜ Not started |
| 12 | Deployment to Render — public URL | ⬜ Not started |
...
| Date | Update |
|---|---|
| May 2026 | Project scoped. Full dataset confirmed for Sample G. Data collection template distributed to collaborating groups. Repository structure and README complete. Build starting. |
